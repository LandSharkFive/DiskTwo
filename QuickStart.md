# Quick Start: Classic B-Tree

Classic BTree is a high-performance, disk-persistent B-Tree engine designed for O(1) seek times and robust data integrity.
...
// Initialize the tree (Order 60 = high-density branching)
// This automatically handles file creation and header padding (4KB)
var tree = new BTree("storage.dat", order: 60);
```
